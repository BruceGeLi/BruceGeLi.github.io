...
function updateIconVisibility(theme) {
    document.getElementById('icon-light-theme').style.display = theme === 'dark' ? 'block' : 'none';
    document.getElementById('icon-dark-theme').style.display = theme === 'light' ? 'block' : 'none';
}
